...
class TaskRestriction(pydantic.BaseModel):
    """
    ...
    repetitions: typing.Optional[PositiveInt] = pydantic.Field(
        description="Indicates the number of times the requested action should occur."
    )
    period: typing.Optional[Period] = pydantic.Field(description="Over what time-period is fulfillment sought.")
