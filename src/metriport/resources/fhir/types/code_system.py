...
class CodeSystem(BaseResource):
    ...
    resource_type: typing_extensions.Literal["CodeSystem"] = pydantic.Field(alias="resourceType")
    ...
    value_set: typing.Optional[Canonical] = pydantic.Field(
        alias="valueSet", description="Canonical reference to the value set that contains the entire code system."
    )
