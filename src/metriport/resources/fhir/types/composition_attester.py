...
class CompositionAttester(pydantic.BaseModel):
    ...
    time: typing.Optional[DateTime] = pydantic.Field(description="When the composition was attested by the party.")
    party: typing.Optional[Reference] = pydantic.Field(description="Who attested the composition in the specified way.")
