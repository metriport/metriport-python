...
class ResearchStudy(BaseResource):
    ...
    part_of: typing.Optional[typing.List[Reference]] = pydantic.Field(
        alias="partOf", description="A larger research study of which this particular study is a component or step."
    )
    ...
    related_artifact: typing.Optional[typing.List[RelatedArtifact]] = pydantic.Field(
        alias="relatedArtifact", description="Citations, references and other related documents."
    )
