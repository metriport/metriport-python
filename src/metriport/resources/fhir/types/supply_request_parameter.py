...
class SupplyRequestParameter(pydantic.BaseModel):
    ...
    value_codeable_concept: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="valueCodeableConcept", description="The value of the device detail."
    )
    value_quantity: typing.Optional[Quantity] = pydantic.Field(
        alias="valueQuantity", description="The value of the device detail."
    )
    value_range: typing.Optional[Range] = pydantic.Field(
        alias="valueRange", description="The value of the device detail."
    )
    value_boolean: typing.Optional[bool] = pydantic.Field(
        alias="valueBoolean", description="The value of the device detail."
    )
