...
class ExplanationOfBenefitSupportingInfo(pydantic.BaseModel):
    ...
    timing_date: typing.Optional[str] = pydantic.Field(
        alias="timingDate", description="The date when or period to which this information refers."
    )
    timing_period: typing.Optional[Period] = pydantic.Field(
        alias="timingPeriod", description="The date when or period to which this information refers."
    )
