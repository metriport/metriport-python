...
class EpisodeOfCareDiagnosis(pydantic.BaseModel):
    """
    ...
    rank: typing.Optional[PositiveInt] = pydantic.Field(description="Ranking of the diagnosis (for each role type).")
