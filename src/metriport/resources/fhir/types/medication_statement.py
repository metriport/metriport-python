...
class MedicationStatement(BaseResource):
    ...
    resource_type: typing_extensions.Literal["MedicationStatement"] = pydantic.Field(alias="resourceType")
    ...
    status_reason: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        alias="statusReason", description="Captures the reason for the current state of the MedicationStatement."
    )
    ...
    reason_code: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        alias="reasonCode", description="A reason for why the medication is being/was taken."
    )
