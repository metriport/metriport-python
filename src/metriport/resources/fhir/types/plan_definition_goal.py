...
class PlanDefinitionGoal(pydantic.BaseModel):
    """
    ...
    start: typing.Optional[CodeableConcept] = pydantic.Field(
        description="The event after which the goal should begin being pursued."
    )
    addresses: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
    ...
    target: typing.Optional[typing.List[PlanDefinitionTarget]] = pydantic.Field(
