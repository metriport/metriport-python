...
class MessageHeaderResponse(pydantic.BaseModel):
    """
    ...
    identifier: typing.Optional[Id] = pydantic.Field(
        description="The MessageHeader.id of the message to which this message is a response."
    )
    code: typing.Optional[MessageHeaderResponseCode] = pydantic.Field(
    ...
    details: typing.Optional[Reference] = pydantic.Field(description="Full details of any issues found in the message.")
