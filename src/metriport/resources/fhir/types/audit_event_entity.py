...
class AuditEventEntity(pydantic.BaseModel):
    ...
    security_label: typing.Optional[typing.List[Coding]] = pydantic.Field(
        alias="securityLabel", description="Security labels for the identified entity."
    )
    name: typing.Optional[str] = pydantic.Field(description="A name of the entity in the audit event.")
    description: typing.Optional[str] = pydantic.Field(description="Text that describes the entity in more detail.")
    query: typing.Optional[Base64Binary] = pydantic.Field(description="The query parameters for a query-type entities.")
