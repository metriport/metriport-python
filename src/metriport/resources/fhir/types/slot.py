...
class Slot(BaseResource):
    ...
    start: typing.Optional[Instant] = pydantic.Field(description="Date/Time that the slot is to begin.")
    end: typing.Optional[Instant] = pydantic.Field(description="Date/Time that the slot is to conclude.")
