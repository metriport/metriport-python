...
class OperationDefinitionParameter(pydantic.BaseModel):
    ...
    name: typing.Optional[Code] = pydantic.Field(description="The name of used to identify the parameter.")
    ...
    documentation: typing.Optional[str] = pydantic.Field(description="Describes the meaning or use of this parameter.")
    type: typing.Optional[Code] = pydantic.Field(description="The type for this parameter.")
