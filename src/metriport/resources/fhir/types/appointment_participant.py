...
class AppointmentParticipant(pydantic.BaseModel):
    """
    ...
    status: typing.Optional[AppointmentParticipantStatus] = pydantic.Field(
        description="Participation status of the actor."
    )
    period: typing.Optional[Period] = pydantic.Field(description="Participation period of the actor.")
