...
class DetectedIssueMitigation(pydantic.BaseModel):
    """
    ...
    action: CodeableConcept = pydantic.Field(
    ...
    date: typing.Optional[DateTime] = pydantic.Field(description="Indicates when the mitigating action was documented.")
