...
class ExplanationOfBenefitAdjudication(pydantic.BaseModel):
    """
    ...
    amount: typing.Optional[Money] = pydantic.Field(description="Monetary amount associated with the category.")
