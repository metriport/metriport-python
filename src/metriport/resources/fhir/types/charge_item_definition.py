...
class ChargeItemDefinition(BaseResource):
    ...
    resource_type: typing_extensions.Literal["ChargeItemDefinition"] = pydantic.Field(alias="resourceType")
    ...
    part_of: typing.Optional[typing.List[Canonical]] = pydantic.Field(
        alias="partOf", description="A larger definition of which this particular definition is a component or step."
    )
