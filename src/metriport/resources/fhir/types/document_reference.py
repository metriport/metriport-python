...
class DocumentReference(BaseResource):
    ...
    doc_status: typing.Optional[Code] = pydantic.Field(
        alias="docStatus", description="The status of the underlying document."
    )
    ...
    date: typing.Optional[Instant] = pydantic.Field(description="When the document reference was created.")
    ...
    description: typing.Optional[str] = pydantic.Field(description="Human-readable description of the source document.")
