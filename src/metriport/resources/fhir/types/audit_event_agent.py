...
class AuditEventAgent(pydantic.BaseModel):
    ...
    name: typing.Optional[str] = pydantic.Field(description="Human-meaningful name for the agent.")
    ...
    location: typing.Optional[Reference] = pydantic.Field(description="Where the event occurred.")
