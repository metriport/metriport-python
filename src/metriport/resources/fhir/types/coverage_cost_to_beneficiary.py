...
class CoverageCostToBeneficiary(pydantic.BaseModel):
    ...
    value_quantity: typing.Optional[Quantity] = pydantic.Field(
        alias="valueQuantity", description="The amount due from the patient for the cost category."
    )
    value_money: typing.Optional[Money] = pydantic.Field(
        alias="valueMoney", description="The amount due from the patient for the cost category."
    )
