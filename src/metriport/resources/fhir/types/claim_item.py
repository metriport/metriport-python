...
class ClaimItem(pydantic.BaseModel):
    ...
    care_team_sequence: typing.Optional[typing.List[PositiveInt]] = pydantic.Field(
        alias="careTeamSequence", description="CareTeam members related to this service or product."
    )
    diagnosis_sequence: typing.Optional[typing.List[PositiveInt]] = pydantic.Field(
        alias="diagnosisSequence", description="Diagnosis applicable for this service or product."
    )
