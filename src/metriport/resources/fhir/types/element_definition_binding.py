...
class ElementDefinitionBinding(pydantic.BaseModel):
    """
    ...
    strength: typing.Optional[ElementDefinitionBindingStrength] = pydantic.Field(
    ...
    value_set: typing.Optional[Canonical] = pydantic.Field(
        alias="valueSet", description="Refers to the value set that identifies the set of codes the binding refers to."
    )
