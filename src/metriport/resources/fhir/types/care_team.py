...
class CareTeam(BaseResource):
    ...
    resource_type: typing_extensions.Literal["CareTeam"] = pydantic.Field(alias="resourceType")
    ...
    reason_code: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        alias="reasonCode", description="Describes why the care team exists."
    )
    reason_reference: typing.Optional[typing.List[Reference]] = pydantic.Field(
        alias="reasonReference", description="Condition(s) that this care team addresses."
    )
    managing_organization: typing.Optional[typing.List[Reference]] = pydantic.Field(
        alias="managingOrganization", description="The organization responsible for the care team."
    )
    ...
    note: typing.Optional[typing.List[Annotation]] = pydantic.Field(description="Comments made about the CareTeam.")
