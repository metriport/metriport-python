...
class VisionPrescriptionLensSpecification(pydantic.BaseModel):
    ...
    sphere: typing.Optional[Decimal] = pydantic.Field(description="Lens power measured in dioptres (0.25 units).")
    ...
    axis: typing.Optional[int] = pydantic.Field(description="Adjustment for astigmatism measured in integer degrees.")
    ...
    back_curve: typing.Optional[Decimal] = pydantic.Field(
        alias="backCurve", description="Back curvature measured in millimetres."
    )
    diameter: typing.Optional[Decimal] = pydantic.Field(description="Contact lens diameter measured in millimetres.")
    duration: typing.Optional[Quantity] = pydantic.Field(
        description="The recommended maximum wear period for the lens."
    )
    color: typing.Optional[str] = pydantic.Field(description="Special color or pattern.")
    brand: typing.Optional[str] = pydantic.Field(description="Brand recommendations or restrictions.")
