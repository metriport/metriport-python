...
class ActivityDefinitionDynamicValue(pydantic.BaseModel):
    """
    ...
    expression: Expression = pydantic.Field(description="An expression specifying the value of the customized element.")
