...
class ChargeItemDefinitionPriceComponent(pydantic.BaseModel):
    ...
    type: typing.Optional[Code] = pydantic.Field(description="This code identifies the type of the component.")
    ...
    amount: typing.Optional[Money] = pydantic.Field(description="The amount calculated for this component.")
