...
class SubstanceSpecificationStructure(pydantic.BaseModel):
    """
    ...
    stereochemistry: typing.Optional[CodeableConcept] = pydantic.Field(description="Stereochemistry type.")
    optical_activity: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="opticalActivity", description="Optical activity type."
    )
    molecular_formula: typing.Optional[str] = pydantic.Field(alias="molecularFormula", description="Molecular formula.")
    molecular_formula_by_moiety: typing.Optional[str] = pydantic.Field(
    ...
    isotope: typing.Optional[typing.List[SubstanceSpecificationIsotope]] = pydantic.Field(
        description="Applicable for single substances that contain a radionuclide or a non-natural isotopic ratio."
    )
    molecular_weight: typing.Optional[SubstanceSpecificationMolecularWeight] = pydantic.Field(
    ...
    representation: typing.Optional[typing.List[SubstanceSpecificationRepresentation]] = pydantic.Field(
