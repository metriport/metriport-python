...
class ElementDefinitionSlicing(pydantic.BaseModel):
    """
    ...
    discriminator: typing.Optional[typing.List[ElementDefinitionDiscriminator]] = pydantic.Field(
    ...
    ordered: typing.Optional[bool] = pydantic.Field(
        description="If the matching elements have to occur in the same order as defined in the profile."
    )
    rules: typing.Optional[ElementDefinitionSlicingRules] = pydantic.Field(
