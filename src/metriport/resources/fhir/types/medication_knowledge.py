...
class MedicationKnowledge(BaseResource):
    ...
    dose_form: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="doseForm", description="Describes the form of the item. Powder; tablets; capsule."
    )
    ...
    related_medication_knowledge: typing.Optional[
        ...
        alias="relatedMedicationKnowledge", description="Associated or related knowledge about a medication."
    )
    ...
    preparation_instruction: typing.Optional[Markdown] = pydantic.Field(
        alias="preparationInstruction", description="The instructions for preparing the medication."
    )
    intended_route: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        alias="intendedRoute", description="The intended or approved route of administration."
    )
    ...
    monitoring_program: typing.Optional[typing.List[MedicationKnowledgeMonitoringProgram]] = pydantic.Field(
        alias="monitoringProgram", description="The program under which the medication is reviewed."
    )
    administration_guidelines: typing.Optional[
        typing.List[MedicationKnowledgeAdministrationGuidelines]
    ] = pydantic.Field(
        alias="administrationGuidelines", description="Guidelines for the administration of the medication."
    )
