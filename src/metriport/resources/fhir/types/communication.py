...
class Communication(BaseResource):
    ...
    based_on: typing.Optional[typing.List[Reference]] = pydantic.Field(
        alias="basedOn", description="An order, proposal or plan fulfilled in whole or in part by this Communication."
    )
    part_of: typing.Optional[typing.List[Reference]] = pydantic.Field(
        alias="partOf", description="Part of this action."
    )
    in_response_to: typing.Optional[typing.List[Reference]] = pydantic.Field(
        alias="inResponseTo", description="Prior communication that this communication is in response to."
    )
    status: typing.Optional[Code] = pydantic.Field(description="The status of the transmission.")
    status_reason: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="statusReason", description="Captures the reason for the current state of the Communication."
    )
    ...
    sent: typing.Optional[DateTime] = pydantic.Field(description="The time when this communication was sent.")
    ...
    reason_code: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        alias="reasonCode", description="The reason or justification for the communication."
    )
    reason_reference: typing.Optional[typing.List[Reference]] = pydantic.Field(
        alias="reasonReference", description="Indicates another resource whose existence justifies this communication."
    )
