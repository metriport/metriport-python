...
class ImagingStudySeries(pydantic.BaseModel):
    ...
    uid: typing.Optional[Id] = pydantic.Field(description="The DICOM Series Instance UID for the series.")
    ...
    description: typing.Optional[str] = pydantic.Field(description="A description of the series.")
    ...
    started: typing.Optional[DateTime] = pydantic.Field(description="The date and time the series was started.")
