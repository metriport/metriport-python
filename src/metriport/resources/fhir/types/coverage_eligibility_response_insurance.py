...
class CoverageEligibilityResponseInsurance(pydantic.BaseModel):
    """
    ...
    inforce: typing.Optional[bool] = pydantic.Field(
    ...
    item: typing.Optional[typing.List[CoverageEligibilityResponseItem]] = pydantic.Field(
