...
class ResearchElementDefinitionCharacteristic(pydantic.BaseModel):
    ...
    study_effective_description: typing.Optional[str] = pydantic.Field(
        alias="studyEffectiveDescription", description="A narrative description of the time period the study covers."
    )
    study_effective_date_time: typing.Optional[str] = pydantic.Field(
        alias="studyEffectiveDateTime", description="Indicates what effective period the study covers."
    )
    study_effective_period: typing.Optional[Period] = pydantic.Field(
        alias="studyEffectivePeriod", description="Indicates what effective period the study covers."
    )
    study_effective_duration: typing.Optional[Duration] = pydantic.Field(
        alias="studyEffectiveDuration", description="Indicates what effective period the study covers."
    )
    study_effective_timing: typing.Optional[Timing] = pydantic.Field(
        alias="studyEffectiveTiming", description="Indicates what effective period the study covers."
    )
    study_effective_time_from_start: typing.Optional[Duration] = pydantic.Field(
        alias="studyEffectiveTimeFromStart", description="Indicates duration from the study initiation."
    )
    ...
    participant_effective_date_time: typing.Optional[str] = pydantic.Field(
        alias="participantEffectiveDateTime", description="Indicates what effective period the study covers."
    )
    participant_effective_period: typing.Optional[Period] = pydantic.Field(
        alias="participantEffectivePeriod", description="Indicates what effective period the study covers."
    )
    participant_effective_duration: typing.Optional[Duration] = pydantic.Field(
        alias="participantEffectiveDuration", description="Indicates what effective period the study covers."
    )
    participant_effective_timing: typing.Optional[Timing] = pydantic.Field(
        alias="participantEffectiveTiming", description="Indicates what effective period the study covers."
    )
    participant_effective_time_from_start: typing.Optional[Duration] = pydantic.Field(
        alias="participantEffectiveTimeFromStart", description="Indicates duration from the participant's study entry."
    )
