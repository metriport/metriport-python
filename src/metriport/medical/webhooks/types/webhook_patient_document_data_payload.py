...
class WebhookPatientDocumentDataPayload(pydantic.BaseModel):
    meta: WebhookMetadataPayload = pydantic.Field(description="The metadata of the webhook.")
    patients: typing.List[WebhookPatientPayload] = pydantic.Field(
        description="An array of WebhookPatientPayload objects."
    )
