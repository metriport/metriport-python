...
class PayloadPatient(pydantic.BaseModel):
    ...
    bundle: typing.Optional[Bundle] = pydantic.Field(
        description="The FHIR bundle with the patient's consolidated data."
    )
    filters: typing.Optional[Filters] = pydantic.Field(description="The filters used to obtain the bundle.")
