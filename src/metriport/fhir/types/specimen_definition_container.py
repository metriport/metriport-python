...
class SpecimenDefinitionContainer(pydantic.BaseModel):
    ...
    material: typing.Optional[CodeableConcept] = pydantic.Field(description="The type of material of the container.")
    ...
    cap: typing.Optional[CodeableConcept] = pydantic.Field(description="Color of container cap.")
    description: typing.Optional[str] = pydantic.Field(description="The textual description of the kind of container.")
    ...
    minimum_volume_quantity: typing.Optional[Quantity] = pydantic.Field(
        alias="minimumVolumeQuantity", description="The minimum volume to be conditioned in the container."
    )
    minimum_volume_string: typing.Optional[str] = pydantic.Field(
        alias="minimumVolumeString", description="The minimum volume to be conditioned in the container."
    )
