...
class Binary(pydantic.BaseModel):
    ...
    content_type: typing.Optional[Code] = pydantic.Field(
        alias="contentType", description="MimeType of the binary content represented as a standard MimeType (BCP 13)."
    )
    security_context: typing.Optional[Reference] = pydantic.Field(
    ...
    data: typing.Optional[Base64Binary] = pydantic.Field(description="The actual content, base64 encoded.")
