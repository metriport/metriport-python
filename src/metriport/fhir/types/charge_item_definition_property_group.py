...
class ChargeItemDefinitionPropertyGroup(pydantic.BaseModel):
    """
    ...
    price_component: typing.Optional[typing.List[ChargeItemDefinitionPriceComponent]] = pydantic.Field(
