...
class ElementDefinitionDiscriminator(pydantic.BaseModel):
    """
    ...
    type: typing.Optional[ElementDefinitionDiscriminatorType] = pydantic.Field(
        default=None, description="How the element value is interpreted when discrimination is evaluated."
    )
