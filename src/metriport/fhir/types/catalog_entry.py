...
class CatalogEntry(BaseResource):
    ...
    orderable: typing.Optional[bool] = pydantic.Field(description="Whether the entry represents an orderable item.")
    ...
    additional_identifier: typing.Optional[typing.List[Identifier]] = pydantic.Field(
        alias="additionalIdentifier", description="Used in supporting related concepts, e.g. NDC to RxNorm."
    )
    ...
    validity_period: typing.Optional[Period] = pydantic.Field(
        alias="validityPeriod", description="The time period in which this catalog entry is expected to be active."
    )
    valid_to: typing.Optional[DateTime] = pydantic.Field(
        alias="validTo", description="The date until which this catalog entry is expected to be active."
    )
    ...
    additional_characteristic: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        alias="additionalCharacteristic", description="Used for examplefor Out of Formulary, or any specifics."
    )
    additional_classification: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        alias="additionalClassification", description="User for example for ATC classification, or."
    )
