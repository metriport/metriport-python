...
class AuditEventAgent(pydantic.BaseModel):
    """
    ...
    type: typing.Optional[CodeableConcept] = pydantic.Field(
        default=None, description="Specification of the participation type the user plays when performing the event."
    )
    ...
    who: typing.Optional[Reference] = pydantic.Field(
        default=None, description="Reference to who this agent is that was involved in the event."
    )
    alt_id: typing.Optional[str] = pydantic.Field(
        alias="altId",
        default=None,
    ...
    name: typing.Optional[str] = pydantic.Field(default=None, description="Human-meaningful name for the agent.")
    requestor: typing.Optional[bool] = pydantic.Field(
        default=None,
        description="Indicator that the user is or is not the requestor, or initiator, for the event being audited.",
    )
    location: typing.Optional[Reference] = pydantic.Field(default=None, description="Where the event occurred.")
    ...
    media: typing.Optional[Coding] = pydantic.Field(
        default=None, description="Type of media involved. Used when the event is about exporting/importing onto media."
    )
    network: typing.Optional[AuditEventNetwork] = pydantic.Field(
        default=None,
        description="Logical network location for application activity, if the activity has a network location.",
    )
    purpose_of_use: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        alias="purposeOfUse",
        default=None,
