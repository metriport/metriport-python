...
class RequestGroupRelatedAction(pydantic.BaseModel):
    """
    ...
    action_id: typing.Optional[Id] = pydantic.Field(
        alias="actionId", default=None, description="The element id of the action this is related to."
    )
    relationship: typing.Optional[Code] = pydantic.Field(
