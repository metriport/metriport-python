...
class Login(pydantic.BaseModel):
    ...
    resource_type: typing_extensions.Literal["Login"] = pydantic.Field(alias="resourceType")
    ...
    client: typing.Optional[Reference] = pydantic.Field(description="The client requesting the code.")
    profile_type: typing.Optional[Code] = pydantic.Field(
        alias="profileType", description="Optional required profile resource type."
    )
    project: typing.Optional[Reference] = pydantic.Field(description="Optional required project for the login.")
    ...
    scope: typing.Optional[str] = pydantic.Field(description="OAuth scope or scopes.")
    ...
    code_challenge: typing.Optional[str] = pydantic.Field(
        alias="codeChallenge", description="PKCE code challenge presented in the authorization request."
    )
    ...
    refresh_secret: typing.Optional[str] = pydantic.Field(
        alias="refreshSecret", description="Optional secure random string that can be used in an OAuth refresh token."
    )
    ...
    granted: typing.Optional[bool] = pydantic.Field(description="Whether a token has been granted for this login.")
    revoked: typing.Optional[bool] = pydantic.Field(description="Whether this login has been revoked or invalidated.")
    admin: typing.Optional[bool] = pydantic.Field(description="DEPRECATED")
    super_admin: typing.Optional[bool] = pydantic.Field(
        alias="superAdmin", description="Whether this login has super administrator privileges."
    )
    launch: typing.Optional[Reference] = pydantic.Field(description="Optional SMART App Launch context for this login.")
    ...
    user_agent: typing.Optional[str] = pydantic.Field(
        alias="userAgent", description="The User-Agent request header as sent by the client."
    )
