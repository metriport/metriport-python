...
class ExplanationOfBenefitRelated(pydantic.BaseModel):
    """
    ...
    claim: typing.Optional[Reference] = pydantic.Field(default=None, description="Reference to a related claim.")
    ...
    reference: typing.Optional[Identifier] = pydantic.Field(
        default=None,
