...
class StructureMapGroup(pydantic.BaseModel):
    """
    ...
    name: typing.Optional[Id] = pydantic.Field(
        default=None, description="A unique name for the group for the convenience of human readers."
    )
    extends: typing.Optional[Id] = pydantic.Field(
        default=None, description="Another group that this group adds rules to."
    )
    type_mode: typing.Optional[StructureMapGroupTypeMode] = pydantic.Field(
        alias="typeMode",
        default=None,
    ...
    input: typing.List[StructureMapInput] = pydantic.Field(
        description="A name assigned to an instance of data. The instance must be provided when the mapping is invoked."
    )
    rule: typing.List[StructureMapRule] = pydantic.Field(description="Transform Rule from source to target.")
