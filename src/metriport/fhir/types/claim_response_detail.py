...
class ClaimResponseDetail(pydantic.BaseModel):
    """
    ...
    detail_sequence: typing.Optional[PositiveInt] = pydantic.Field(
        alias="detailSequence", default=None, description="A number to uniquely reference the claim detail entry."
    )
    ...
    sub_detail: typing.Optional[typing.List[ClaimResponseSubDetail]] = pydantic.Field(
        alias="subDetail", default=None, description="A sub-detail adjudication of a simple product or service."
    )
