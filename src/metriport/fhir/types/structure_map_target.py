...
class StructureMapTarget(pydantic.BaseModel):
    ...
    context_type: typing.Optional[StructureMapTargetContextType] = pydantic.Field(
        alias="contextType", description="How to interpret the context."
    )
    element: typing.Optional[str] = pydantic.Field(description="Field to create in the context.")
    ...
    list_mode: typing.Optional[typing.List[StructureMapTargetListModeItem]] = pydantic.Field(
        alias="listMode", description="If field is a list, how to manage the list."
    )
    list_rule_id: typing.Optional[Id] = pydantic.Field(
        alias="listRuleId", description="Internal rule reference for shared list items."
    )
