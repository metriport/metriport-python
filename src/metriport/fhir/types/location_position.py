...
class LocationPosition(pydantic.BaseModel):
    """
    ...
    longitude: typing.Optional[Decimal] = pydantic.Field(
        default=None,
    ...
    latitude: typing.Optional[Decimal] = pydantic.Field(
        default=None,
    ...
    altitude: typing.Optional[Decimal] = pydantic.Field(
        default=None,
