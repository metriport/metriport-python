...
class MedicationDispenseSubstitution(pydantic.BaseModel):
    """
    ...
    was_substituted: typing.Optional[bool] = pydantic.Field(
    ...
    responsible_party: typing.Optional[typing.List[Reference]] = pydantic.Field(
