...
class SubstanceSourceMaterialAuthor(pydantic.BaseModel):
    """
    ...
    author_type: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="authorType",
        default=None,
    ...
    author_description: typing.Optional[str] = pydantic.Field(
