...
class CapabilityStatementDocument(pydantic.BaseModel):
    """
    ...
    mode: typing.Optional[CapabilityStatementDocumentMode] = pydantic.Field(
        default=None,
    ...
    profile: Canonical = pydantic.Field(
