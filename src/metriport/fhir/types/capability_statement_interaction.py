...
class CapabilityStatementInteraction(pydantic.BaseModel):
    """
    ...
    code: typing.Optional[CapabilityStatementInteractionCode] = pydantic.Field(
        default=None, description="Coded identifier of the operation, supported by the system resource."
    )
