...
class GuidanceResponse(BaseResource):
    ...
    subject: typing.Optional[Reference] = pydantic.Field(description="The patient for which the request was processed.")
    ...
    occurrence_date_time: typing.Optional[DateTime] = pydantic.Field(
        alias="occurrenceDateTime", description="Indicates when the guidance response was processed."
    )
    ...
    reason_code: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        alias="reasonCode", description="Describes the reason for the guidance response in coded or textual form."
    )
