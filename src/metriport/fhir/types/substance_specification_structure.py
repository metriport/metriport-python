...
class SubstanceSpecificationStructure(pydantic.BaseModel):
    ...
    stereochemistry: typing.Optional[CodeableConcept] = pydantic.Field(
        default=None, description="Stereochemistry type."
    )
    optical_activity: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="opticalActivity", default=None, description="Optical activity type."
    )
    molecular_formula: typing.Optional[str] = pydantic.Field(
        alias="molecularFormula", default=None, description="Molecular formula."
    )
