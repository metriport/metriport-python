...
class BiologicallyDerivedProductCollection(pydantic.BaseModel):
    """
    ...
    collector: typing.Optional[Reference] = pydantic.Field(
        default=None, description="Healthcare professional who is performing the collection."
    )
    ...
    collected_date_time: typing.Optional[str] = pydantic.Field(
        alias="collectedDateTime", default=None, description="Time of product collection."
    )
    collected_period: typing.Optional[Period] = pydantic.Field(
        alias="collectedPeriod", default=None, description="Time of product collection."
    )
