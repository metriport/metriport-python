...
class StructureDefinitionContext(pydantic.BaseModel):
    """
    ...
    type: typing.Optional[StructureDefinitionContextType] = pydantic.Field(
        default=None,
    ...
    expression: typing.Optional[str] = pydantic.Field(
        default=None, description="An expression that defines where an extension can be used in resources."
    )
