...
class CoverageEligibilityRequestInsurance(pydantic.BaseModel):
    """
    ...
    focal: typing.Optional[bool] = pydantic.Field(
        default=None,
    ...
    business_arrangement: typing.Optional[str] = pydantic.Field(
