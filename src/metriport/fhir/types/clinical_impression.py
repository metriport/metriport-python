...
class ClinicalImpression(BaseResource):
    ...
    resource_type: typing_extensions.Literal["ClinicalImpression"] = pydantic.Field(alias="resourceType")
    ...
    status: typing.Optional[Code] = pydantic.Field(description="Identifies the workflow status of the assessment.")
    status_reason: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="statusReason", description="Captures the reason for the current state of the ClinicalImpression."
    )
    ...
    effective_date_time: typing.Optional[str] = pydantic.Field(
        alias="effectiveDateTime", description="The point in time or period over which the subject was assessed."
    )
    effective_period: typing.Optional[Period] = pydantic.Field(
        alias="effectivePeriod", description="The point in time or period over which the subject was assessed."
    )
    date: typing.Optional[DateTime] = pydantic.Field(
        description="Indicates when the documentation of the assessment was complete."
    )
    assessor: typing.Optional[Reference] = pydantic.Field(description="The clinician performing the assessment.")
    ...
    prognosis_codeable_concept: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        alias="prognosisCodeableConcept", description="Estimate of likely outcome."
    )
    prognosis_reference: typing.Optional[typing.List[Reference]] = pydantic.Field(
        alias="prognosisReference", description="RiskAssessment expressing likely outcome."
    )
    supporting_info: typing.Optional[typing.List[Reference]] = pydantic.Field(
        alias="supportingInfo", description="Information supporting the clinical impression."
    )
