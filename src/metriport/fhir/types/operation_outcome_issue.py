...
class OperationOutcomeIssue(pydantic.BaseModel):
    """
    ...
    severity: typing.Optional[OperationOutcomeIssueSeverity] = pydantic.Field(
        default=None, description="Indicates whether the issue indicates a variation from successful processing."
    )
    code: typing.Optional[OperationOutcomeIssueCode] = pydantic.Field(
        default=None,
        description="Describes the type of the issue. The system that creates an OperationOutcome SHALL choose the most applicable code from the IssueType value set, and may additional provide its own code for the error in the details element.",
    )
    details: typing.Optional[CodeableConcept] = pydantic.Field(
        default=None,
        description="Additional details about the error. This may be a text description of the error or a system code that identifies the error.",
    )
    diagnostics: typing.Optional[str] = pydantic.Field(
        default=None, description="Additional diagnostic information about the issue."
    )
    location: typing.Optional[typing.List[str]] = pydantic.Field(
        default=None,
    ...
    expression: typing.Optional[typing.List[str]] = pydantic.Field(
        default=None,
