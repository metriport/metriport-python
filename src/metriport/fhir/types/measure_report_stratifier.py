...
class MeasureReportStratifier(pydantic.BaseModel):
    """
    ...
    code: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        default=None, description="The meaning of this stratifier, as defined in the measure definition."
    )
    stratum: typing.Optional[typing.List[MeasureReportStratum]] = pydantic.Field(
        default=None,
