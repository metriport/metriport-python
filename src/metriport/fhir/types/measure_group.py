...
class MeasureGroup(pydantic.BaseModel):
    """
    ...
    description: typing.Optional[str] = pydantic.Field(
        default=None, description="The human readable description of this population group."
    )
    population: typing.Optional[typing.List[MeasurePopulation]] = pydantic.Field(
        default=None, description="A population criteria for the measure."
    )
    stratifier: typing.Optional[typing.List[MeasureStratifier]] = pydantic.Field(
        default=None,
