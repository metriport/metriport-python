...
class ExplanationOfBenefitItem(pydantic.BaseModel):
    """
    ...
    care_team_sequence: typing.Optional[typing.List[PositiveInt]] = pydantic.Field(
        alias="careTeamSequence", default=None, description="Care team members related to this service or product."
    )
    diagnosis_sequence: typing.Optional[typing.List[PositiveInt]] = pydantic.Field(
        alias="diagnosisSequence", default=None, description="Diagnoses applicable for this service or product."
    )
    ...
    encounter: typing.Optional[typing.List[Reference]] = pydantic.Field(
        default=None, description="A billed item may include goods or services provided in multiple encounters."
    )
    ...
    detail: typing.Optional[typing.List[ExplanationOfBenefitDetail]] = pydantic.Field(
