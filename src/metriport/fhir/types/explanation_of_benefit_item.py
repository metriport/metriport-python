...
class ExplanationOfBenefitItem(pydantic.BaseModel):
    ...
    sequence: typing.Optional[PositiveInt] = pydantic.Field(description="A number to uniquely identify item entries.")
    care_team_sequence: typing.Optional[typing.List[PositiveInt]] = pydantic.Field(
        alias="careTeamSequence", description="Care team members related to this service or product."
    )
    diagnosis_sequence: typing.Optional[typing.List[PositiveInt]] = pydantic.Field(
        alias="diagnosisSequence", description="Diagnoses applicable for this service or product."
    )
    procedure_sequence: typing.Optional[typing.List[PositiveInt]] = pydantic.Field(
        alias="procedureSequence", description="Procedures applicable for this service or product."
    )
    ...
    location_codeable_concept: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="locationCodeableConcept", description="Where the product or service was provided."
    )
    location_address: typing.Optional[Address] = pydantic.Field(
        alias="locationAddress", description="Where the product or service was provided."
    )
    location_reference: typing.Optional[Reference] = pydantic.Field(
        alias="locationReference", description="Where the product or service was provided."
    )
    ...
    body_site: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="bodySite", description="Physical service site on the patient (limb, tooth, etc.)."
    )
    sub_site: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        alias="subSite", description="A region or surface of the bodySite, e.g. limb region or tooth surface(s)."
    )
