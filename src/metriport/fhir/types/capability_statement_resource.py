...
class CapabilityStatementResource(pydantic.BaseModel):
    ...
    type: typing.Optional[Code] = pydantic.Field(description="A type of resource exposed via the restful interface.")
    ...
    conditional_create: typing.Optional[bool] = pydantic.Field(
        alias="conditionalCreate", description="A flag that indicates that the server supports conditional create."
    )
    conditional_read: typing.Optional[CapabilityStatementResourceConditionalRead] = pydantic.Field(
        alias="conditionalRead", description="A code that indicates how the server supports conditional read."
    )
    conditional_update: typing.Optional[bool] = pydantic.Field(
        alias="conditionalUpdate", description="A flag that indicates that the server supports conditional update."
    )
    conditional_delete: typing.Optional[CapabilityStatementResourceConditionalDelete] = pydantic.Field(
        alias="conditionalDelete", description="A code that indicates how the server supports conditional delete."
    )
    reference_policy: typing.Optional[typing.List[CapabilityStatementResourceReferencePolicyItem]] = pydantic.Field(
        alias="referencePolicy", description="A set of flags that defines how references are supported."
    )
    search_include: typing.Optional[typing.List[str]] = pydantic.Field(
        alias="searchInclude", description="A list of \_include values supported by the server."
    )
    search_rev_include: typing.Optional[typing.List[str]] = pydantic.Field(
        alias="searchRevInclude", description="A list of \_revinclude (reverse include) values supported by the server."
    )
