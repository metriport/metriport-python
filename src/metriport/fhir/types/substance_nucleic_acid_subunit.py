...
class SubstanceNucleicAcidSubunit(pydantic.BaseModel):
    """
    ...
    length: typing.Optional[int] = pydantic.Field(description="The length of the sequence shall be captured.")
    sequence_attachment: typing.Optional[Attachment] = pydantic.Field(alias="sequenceAttachment", description="(TBC).")
    five_prime: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="fivePrime",
    ...
    three_prime: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="threePrime",
