...
class SpecimenDefinitionTypeTested(pydantic.BaseModel):
    ...
    is_derived: typing.Optional[bool] = pydantic.Field(alias="isDerived", description="Primary of secondary specimen.")
    ...
    container: typing.Optional[SpecimenDefinitionContainer] = pydantic.Field(description="The specimen's container.")
