...
class SubstanceAmount(pydantic.BaseModel):
    """
    ...
    amount_text: typing.Optional[str] = pydantic.Field(
        alias="amountText", description="A textual comment on a numeric value."
    )
    reference_range: typing.Optional[SubstanceAmountReferenceRange] = pydantic.Field(
        alias="referenceRange", description="Reference range of possible or expected values."
    )
