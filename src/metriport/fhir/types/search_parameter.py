...
class SearchParameter(BaseResource):
    ...
    resource_type: typing_extensions.Literal["SearchParameter"] = pydantic.Field(alias="resourceType")
    ...
    description: typing.Optional[Markdown] = pydantic.Field(description="And how it used.")
