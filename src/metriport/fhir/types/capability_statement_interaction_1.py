...
class CapabilityStatementInteraction1(pydantic.BaseModel):
    """
    ...
    code: typing.Optional[CapabilityStatementInteraction1Code] = pydantic.Field(
        default=None, description="A coded identifier of the operation, supported by the system."
    )
