...
class CompartmentDefinition(BaseResource):
    ...
    resource_type: typing_extensions.Literal["CompartmentDefinition"] = pydantic.Field(alias="resourceType")
    ...
    search: typing.Optional[bool] = pydantic.Field(description="Whether the search syntax is supported,.")
