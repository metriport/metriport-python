...
class ExampleScenario(BaseResource):
    ...
    resource_type: typing_extensions.Literal["ExampleScenario"] = pydantic.Field(alias="resourceType")
    ...
    workflow: typing.Optional[typing.List[Canonical]] = pydantic.Field(description="Another nested workflow.")
