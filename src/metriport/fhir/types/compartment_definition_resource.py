...
class CompartmentDefinitionResource(pydantic.BaseModel):
    """
    ...
    code: typing.Optional[Code] = pydantic.Field(
        default=None, description="The name of a resource supported by the server."
    )
    param: typing.Optional[typing.List[str]] = pydantic.Field(
        default=None,
    ...
    documentation: typing.Optional[str] = pydantic.Field(
        default=None, description="Additional documentation about the resource and compartment."
    )
