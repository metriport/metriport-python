...
class MedicationRequestSubstitution(pydantic.BaseModel):
    """
    ...
    allowed_boolean: typing.Optional[bool] = pydantic.Field(
        alias="allowedBoolean",
        default=None,
        description="True if the prescriber allows a different drug to be dispensed from what was prescribed.",
    )
    allowed_codeable_concept: typing.Optional[CodeableConcept] = pydantic.Field(
