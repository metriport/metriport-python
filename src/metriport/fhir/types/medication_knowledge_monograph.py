...
class MedicationKnowledgeMonograph(pydantic.BaseModel):
    """
    ...
    source: typing.Optional[Reference] = pydantic.Field(description="Associated documentation about the medication.")
