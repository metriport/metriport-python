...
class MedicationKnowledgeCost(pydantic.BaseModel):
    """
    ...
    source: typing.Optional[str] = pydantic.Field(
        default=None, description="The source or owner that assigns the price to the medication."
    )
    cost: Money = pydantic.Field(description="The price of the medication.")
