...
class ExampleScenarioAlternative(pydantic.BaseModel):
    """
    ...
    step: typing.Optional[typing.List[ExampleScenarioStep]] = pydantic.Field(
...
ExampleScenarioAlternative.update_forward_refs()
