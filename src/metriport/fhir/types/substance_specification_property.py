...
class SubstanceSpecificationProperty(pydantic.BaseModel):
    """
    ...
    category: typing.Optional[CodeableConcept] = pydantic.Field(
        default=None, description="A category for this property, e.g. Physical, Chemical, Enzymatic."
    )
    ...
    parameters: typing.Optional[str] = pydantic.Field(
        default=None,
    ...
    defining_substance_reference: typing.Optional[Reference] = pydantic.Field(
    ...
    defining_substance_codeable_concept: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="definingSubstanceCodeableConcept",
        default=None,
        description="A substance upon which a defining property depends (e.g. for solubility: in water, in alcohol).",
    )
    amount_quantity: typing.Optional[Quantity] = pydantic.Field(
        alias="amountQuantity", default=None, description="Quantitative value for this property."
    )
    amount_string: typing.Optional[str] = pydantic.Field(
        alias="amountString", default=None, description="Quantitative value for this property."
    )
