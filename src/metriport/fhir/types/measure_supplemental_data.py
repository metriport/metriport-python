...
class MeasureSupplementalData(pydantic.BaseModel):
    """
    ...
    usage: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        default=None,
    ...
    description: typing.Optional[str] = pydantic.Field(
        default=None, description="The human readable description of this supplemental data."
    )
