...
class ClinicalImpressionInvestigation(pydantic.BaseModel):
    """
    ...
    code: CodeableConcept = pydantic.Field(
        description=(
            ...
            "family\n"
            "travel\n"
            "nutritional) history may be used.\n"
        )
    )
    item: typing.Optional[typing.List[Reference]] = pydantic.Field(
        default=None, description="A record of a specific investigation that was undertaken."
    )
