...
class TestScriptVariable(pydantic.BaseModel):
    """
    ...
    name: typing.Optional[str] = pydantic.Field(description="Descriptive name for this variable.")
    default_value: typing.Optional[str] = pydantic.Field(
        alias="defaultValue", description="A default, hard-coded, or user-defined value for this variable."
    )
    ...
    hint: typing.Optional[str] = pydantic.Field(
