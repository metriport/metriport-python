...
class TestScriptCapability(pydantic.BaseModel):
    """
    ...
    validated: typing.Optional[bool] = pydantic.Field(
    ...
    origin: typing.Optional[typing.List[int]] = pydantic.Field(
        description="Which origin server these requirements apply to."
    )
    destination: typing.Optional[int] = pydantic.Field(description="Which server these requirements apply to.")
    link: typing.Optional[typing.List[Uri]] = pydantic.Field(
        description="Links to the FHIR specification that describes this interaction and the resources involved in more detail."
    )
    capabilities: Canonical = pydantic.Field(
