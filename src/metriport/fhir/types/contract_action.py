...
class ContractAction(pydantic.BaseModel):
    ...
    do_not_perform: typing.Optional[bool] = pydantic.Field(
        alias="doNotPerform", description="True if the term prohibits the action."
    )
    ...
    subject: typing.Optional[typing.List[ContractSubject]] = pydantic.Field(description="Entity of the action.")
    ...
    occurrence_date_time: typing.Optional[str] = pydantic.Field(
        alias="occurrenceDateTime", description="When action happens."
    )
    occurrence_period: typing.Optional[Period] = pydantic.Field(
        alias="occurrencePeriod", description="When action happens."
    )
    occurrence_timing: typing.Optional[Timing] = pydantic.Field(
        alias="occurrenceTiming", description="When action happens."
    )
    ...
    security_label_number: typing.Optional[typing.List[UnsignedInt]] = pydantic.Field(
        alias="securityLabelNumber", description="Security labels that protects the action."
    )
