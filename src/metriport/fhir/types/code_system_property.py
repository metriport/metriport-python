...
class CodeSystemProperty(pydantic.BaseModel):
    """
    ...
    description: typing.Optional[str] = pydantic.Field(
        default=None, description="A description of the property- why it is defined, and how its value might be used."
    )
    type: typing.Optional[CodeSystemPropertyType] = pydantic.Field(
        default=None,
