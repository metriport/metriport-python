...
class SupplyRequest(BaseResource):
    ...
    status: typing.Optional[SupplyRequestStatus] = pydantic.Field(description="Status of the supply request.")
    ...
    occurrence_date_time: typing.Optional[str] = pydantic.Field(
        alias="occurrenceDateTime", description="When the request should be fulfilled."
    )
    occurrence_period: typing.Optional[Period] = pydantic.Field(
        alias="occurrencePeriod", description="When the request should be fulfilled."
    )
    occurrence_timing: typing.Optional[Timing] = pydantic.Field(
        alias="occurrenceTiming", description="When the request should be fulfilled."
    )
    authored_on: typing.Optional[DateTime] = pydantic.Field(
        alias="authoredOn", description="When the request was made."
    )
    ...
    reason_code: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        alias="reasonCode", description="The reason why the supply item was requested."
    )
    reason_reference: typing.Optional[typing.List[Reference]] = pydantic.Field(
        alias="reasonReference", description="The reason why the supply item was requested."
    )
    deliver_from: typing.Optional[Reference] = pydantic.Field(
        alias="deliverFrom", description="Where the supply is expected to come from."
    )
    deliver_to: typing.Optional[Reference] = pydantic.Field(
        alias="deliverTo", description="Where the supply is destined to go."
    )
