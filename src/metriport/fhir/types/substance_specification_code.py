...
class SubstanceSpecificationCode(pydantic.BaseModel):
    ...
    code: typing.Optional[CodeableConcept] = pydantic.Field(description="The specific code.")
    status: typing.Optional[CodeableConcept] = pydantic.Field(description="Status of the code assignment.")
