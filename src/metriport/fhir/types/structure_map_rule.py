...
class StructureMapRule(pydantic.BaseModel):
    ...
    name: typing.Optional[Id] = pydantic.Field(description="Name of the rule for internal references.")
    ...
    rule: typing.Optional[typing.List[StructureMapRule]] = pydantic.Field(description="Rules contained in this rule.")
