...
class ExplanationOfBenefitDetail(pydantic.BaseModel):
    """
    ...
    sub_detail: typing.Optional[typing.List[ExplanationOfBenefitSubDetail]] = pydantic.Field(
        alias="subDetail", default=None, description="Third-tier of goods and services."
    )
