...
class ExplanationOfBenefitPayment(pydantic.BaseModel):
    ...
    adjustment_reason: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="adjustmentReason", description="Reason for the payment adjustment."
    )
    ...
    amount: typing.Optional[Money] = pydantic.Field(description="Benefits payable less any payment adjustment.")
