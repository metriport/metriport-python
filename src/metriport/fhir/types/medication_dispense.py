...
class MedicationDispense(BaseResource):
    ...
    resource_type: typing_extensions.Literal["MedicationDispense"] = pydantic.Field(alias="resourceType")
    ...
    part_of: typing.Optional[typing.List[Reference]] = pydantic.Field(
        alias="partOf", description="The procedure that trigger the dispense."
    )
    ...
    status_reason_codeable_concept: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="statusReasonCodeableConcept", description="Indicates the reason why a dispense was not performed."
    )
    status_reason_reference: typing.Optional[Reference] = pydantic.Field(
        alias="statusReasonReference", description="Indicates the reason why a dispense was not performed."
    )
    ...
    authorizing_prescription: typing.Optional[typing.List[Reference]] = pydantic.Field(
        alias="authorizingPrescription", description="Indicates the medication order that is being dispensed against."
    )
    ...
    days_supply: typing.Optional[Quantity] = pydantic.Field(
        alias="daysSupply", description="The amount of medication expressed as a timing amount."
    )
    when_prepared: typing.Optional[DateTime] = pydantic.Field(
        alias="whenPrepared", description="The time when the dispensed product was packaged and reviewed."
    )
