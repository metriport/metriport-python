...
class ExplanationOfBenefitDetail1(pydantic.BaseModel):
    """
    ...
    sub_detail: typing.Optional[typing.List[ExplanationOfBenefitSubDetail1]] = pydantic.Field(
        alias="subDetail", default=None, description="The third-tier service adjudications for payor added services."
    )
