...
class MeasureReportGroup(pydantic.BaseModel):
    """
    ...
    code: typing.Optional[CodeableConcept] = pydantic.Field(
        default=None, description="The meaning of the population group as defined in the measure definition."
    )
    population: typing.Optional[typing.List[MeasureReportPopulation]] = pydantic.Field(
        default=None,
    ...
    stratifier: typing.Optional[typing.List[MeasureReportStratifier]] = pydantic.Field(
        default=None,
