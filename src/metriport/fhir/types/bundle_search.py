...
class BundleSearch(pydantic.BaseModel):
    """
    ...
    mode: typing.Optional[BundleSearchMode] = pydantic.Field(
        default=None,
    ...
    score: typing.Optional[Decimal] = pydantic.Field(
        default=None, description="When searching, the server's search ranking score for the entry."
    )
