...
class EncounterHospitalization(pydantic.BaseModel):
    ...
    pre_admission_identifier: typing.Optional[Identifier] = pydantic.Field(
        alias="preAdmissionIdentifier", description="Pre-admission identifier."
    )
    ...
    admit_source: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="admitSource", description="From where patient was admitted (physician referral, transfer)."
    )
    re_admission: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="reAdmission", description="Whether this hospitalization is a readmission and why if known."
    )
    diet_preference: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        alias="dietPreference", description="Diet preferences reported by the patient."
    )
    special_courtesy: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        alias="specialCourtesy", description="Special courtesies (VIP, board member)."
    )
    ...
    discharge_disposition: typing.Optional[CodeableConcept] = pydantic.Field(
        alias="dischargeDisposition", description="Category or kind of location after discharge."
    )
