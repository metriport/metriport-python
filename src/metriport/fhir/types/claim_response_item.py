...
class ClaimResponseItem(pydantic.BaseModel):
    """
    ...
    item_sequence: typing.Optional[PositiveInt] = pydantic.Field(
        alias="itemSequence", description="A number to uniquely reference the claim item entries."
    )
    ...
    detail: typing.Optional[typing.List[ClaimResponseDetail]] = pydantic.Field(
