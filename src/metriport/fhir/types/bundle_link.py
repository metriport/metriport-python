...
class BundleLink(pydantic.BaseModel):
    """
    ...
    relation: typing.Optional[str] = pydantic.Field(
        default=None,
    ...
    url: typing.Optional[Uri] = pydantic.Field(default=None, description="The reference details for the link.")
