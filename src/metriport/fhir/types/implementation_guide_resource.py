...
class ImplementationGuideResource(pydantic.BaseModel):
    """
    ...
    reference: Reference = pydantic.Field(description="Where this resource is found.")
    fhir_version: typing.Optional[typing.List[ImplementationGuideResourceFhirVersionItem]] = pydantic.Field(
        alias="fhirVersion",
        default=None,
    ...
    example_boolean: typing.Optional[bool] = pydantic.Field(
    ...
    example_canonical: typing.Optional[str] = pydantic.Field(
        alias="exampleCanonical",
        default=None,
        description="If true or a reference, indicates the resource is an example instance. If a reference is present, indicates that the example is an example of the specified profile.",
    )
    grouping_id: typing.Optional[Id] = pydantic.Field(
        alias="groupingId", default=None, description="Reference to the id of the grouping this resource appears in."
    )
