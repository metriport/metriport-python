...
class SubstanceNucleicAcidLinkage(pydantic.BaseModel):
    """
    ...
    connectivity: typing.Optional[str] = pydantic.Field(
    ...
    residue_site: typing.Optional[str] = pydantic.Field(
        alias="residueSite", description="Residues shall be captured as described in 5.3.6.8.3."
    )
