...
class ImplementationGuideManifest(pydantic.BaseModel):
    """
    ...
    rendering: typing.Optional[Url] = pydantic.Field(
        default=None, description="A pointer to official web page, PDF or other rendering of the implementation guide."
    )
    resource: typing.List[ImplementationGuideResource1] = pydantic.Field(
    ...
    page: typing.Optional[typing.List[ImplementationGuidePage1]] = pydantic.Field(
        default=None, description="Information about a page within the IG."
    )
    image: typing.Optional[typing.List[str]] = pydantic.Field(
        default=None, description="Indicates a relative path to an image that exists within the IG."
    )
    other: typing.Optional[typing.List[str]] = pydantic.Field(
        default=None,
