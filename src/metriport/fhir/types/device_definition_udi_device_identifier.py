...
class DeviceDefinitionUdiDeviceIdentifier(pydantic.BaseModel):
    """
    ...
    issuer: typing.Optional[Uri] = pydantic.Field(
        default=None, description="The organization that assigns the identifier algorithm."
    )
    jurisdiction: typing.Optional[Uri] = pydantic.Field(
        default=None, description="The jurisdiction to which the deviceIdentifier applies."
    )
