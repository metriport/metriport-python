...
class ContractOffer(pydantic.BaseModel):
    ...
    party: typing.Optional[typing.List[ContractParty]] = pydantic.Field(description="Offer Recipient.")
    ...
    decision_mode: typing.Optional[typing.List[CodeableConcept]] = pydantic.Field(
        alias="decisionMode", description="How the decision about a Contract was conveyed."
    )
    answer: typing.Optional[typing.List[ContractAnswer]] = pydantic.Field(description="Response to offer text.")
    text: typing.Optional[str] = pydantic.Field(description="Human readable form of this Contract Offer.")
    ...
    security_label_number: typing.Optional[typing.List[UnsignedInt]] = pydantic.Field(
        alias="securityLabelNumber", description="Security labels that protects the offer."
    )
