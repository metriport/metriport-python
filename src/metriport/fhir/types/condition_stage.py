...
class ConditionStage(pydantic.BaseModel):
    """
    ...
    summary: typing.Optional[CodeableConcept] = pydantic.Field(
        default=None,
        description='A simple summary of the stage such as "Stage 3". The determination of the stage is disease-specific.',
    )
    assessment: typing.Optional[typing.List[Reference]] = pydantic.Field(
        default=None,
    ...
    type: typing.Optional[CodeableConcept] = pydantic.Field(
        default=None, description="The kind of staging, such as pathological or clinical staging."
    )
