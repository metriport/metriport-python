...
class PatientContact(pydantic.BaseModel):
    ...
    name: typing.Optional[HumanName] = pydantic.Field(description="A name associated with the contact person.")
    telecom: typing.Optional[typing.List[ContactPoint]] = pydantic.Field(
        description="A contact detail for the person, e.g. a telephone number or an email address."
    )
    address: typing.Optional[Address] = pydantic.Field(description="Address for the contact person.")
