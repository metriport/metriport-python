...
class CodeSystemFilter(pydantic.BaseModel):
    """
    ...
    operator: typing.Optional[typing.List[Code]] = pydantic.Field(
        default=None, description="A list of operators that can be used with the filter."
    )
    value: typing.Optional[str] = pydantic.Field(
        default=None, description="A description of what the value for the filter should be."
    )
