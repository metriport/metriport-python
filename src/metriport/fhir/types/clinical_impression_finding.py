...
class ClinicalImpressionFinding(pydantic.BaseModel):
    """
    ...
    basis: typing.Optional[str] = pydantic.Field(description="Which investigations support finding or diagnosis.")
