...
class CoverageEligibilityRequestItem(pydantic.BaseModel):
    ...
    unit_price: typing.Optional[Money] = pydantic.Field(
        alias="unitPrice", description="The amount charged to the patient by the provider for a single unit."
    )
    facility: typing.Optional[Reference] = pydantic.Field(description="Facility where the services will be provided.")
