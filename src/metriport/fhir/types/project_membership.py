...
class ProjectMembership(pydantic.BaseModel):
    ...
    invited_by: typing.Optional[Reference] = pydantic.Field(
        alias="invitedBy", description="The project administrator who invited the user to the project."
    )
    ...
    access_policy: typing.Optional[Reference] = pydantic.Field(
        alias="accessPolicy", description="The access policy for the user within the project memebership."
    )
    ...
    admin: typing.Optional[bool] = pydantic.Field(description="Whether this user is a project administrator.")
