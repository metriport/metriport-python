...
class ExplanationOfBenefitAccident(pydantic.BaseModel):
    ...
    location_address: typing.Optional[Address] = pydantic.Field(
        alias="locationAddress", description="The physical location of the accident event."
    )
    location_reference: typing.Optional[Reference] = pydantic.Field(
        alias="locationReference", description="The physical location of the accident event."
    )
