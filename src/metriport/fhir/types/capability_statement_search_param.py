...
class CapabilityStatementSearchParam(pydantic.BaseModel):
    """
    ...
    name: typing.Optional[str] = pydantic.Field(description="The name of the search parameter used in the interface.")
    ...
    type: typing.Optional[CapabilityStatementSearchParamType] = pydantic.Field(
