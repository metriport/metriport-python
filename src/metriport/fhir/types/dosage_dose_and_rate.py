...
class DosageDoseAndRate(pydantic.BaseModel):
    ...
    dose_range: typing.Optional[Range] = pydantic.Field(alias="doseRange", description="Amount of medication per dose.")
    dose_quantity: typing.Optional[Quantity] = pydantic.Field(
        alias="doseQuantity", description="Amount of medication per dose."
    )
    rate_ratio: typing.Optional[Ratio] = pydantic.Field(
        alias="rateRatio", description="Amount of medication per unit of time."
    )
    rate_range: typing.Optional[Range] = pydantic.Field(
        alias="rateRange", description="Amount of medication per unit of time."
    )
    rate_quantity: typing.Optional[Quantity] = pydantic.Field(
        alias="rateQuantity", description="Amount of medication per unit of time."
    )
