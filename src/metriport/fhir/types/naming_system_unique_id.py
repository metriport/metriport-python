...
class NamingSystemUniqueId(pydantic.BaseModel):
    """
    ...
    type: typing.Optional[NamingSystemUniqueIdType] = pydantic.Field(
        default=None, description="Identifies the unique identifier scheme used for this particular identifier."
    )
    ...
    preferred: typing.Optional[bool] = pydantic.Field(
        default=None, description='Indicates whether this identifier is the "preferred" identifier of this type.'
    )
    comment: typing.Optional[str] = pydantic.Field(
        default=None, description="Notes about the past or intended usage of this identifier."
    )
