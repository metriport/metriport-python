...
class MeasureReportPopulation1(pydantic.BaseModel):
    """
    ...
    code: typing.Optional[CodeableConcept] = pydantic.Field(default=None, description="The type of the population.")
    count: typing.Optional[int] = pydantic.Field(
        default=None, description="The number of members of the population in this stratum."
    )
