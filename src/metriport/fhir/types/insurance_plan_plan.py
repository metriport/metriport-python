...
class InsurancePlanPlan(pydantic.BaseModel):
    ...
    network: typing.Optional[typing.List[Reference]] = pydantic.Field(
        default=None, description="Reference to the network that providing the type of coverage."
    )
    general_cost: typing.Optional[typing.List[InsurancePlanGeneralCost]] = pydantic.Field(
        alias="generalCost", default=None, description="Overall costs associated with the plan."
    )
    specific_cost: typing.Optional[typing.List[InsurancePlanSpecificCost]] = pydantic.Field(
        alias="specificCost", default=None, description="Costs associated with the coverage provided by the product."
    )
