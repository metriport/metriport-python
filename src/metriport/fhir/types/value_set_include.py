...
class ValueSetInclude(pydantic.BaseModel):
    """
    ...
    concept: typing.Optional[typing.List[ValueSetConcept]] = pydantic.Field(
        description="Specifies a concept to be included or excluded."
    )
    filter: typing.Optional[typing.List[ValueSetFilter]] = pydantic.Field(
    ...
    value_set: typing.Optional[typing.List[Canonical]] = pydantic.Field(
        alias="valueSet",
